...
CodeBehind="acm014.aspx.cs" Inherits="Saving.CriteriaIReport.u_cri_acc_tribalance.acm014" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlace" runat="server">
    <center>
        <asp:Label ID="Label1" runat="server" Font-Bold="true" Font-Size="Medium">	รายงานงบทดลอง_Excel</asp:Label><br />
