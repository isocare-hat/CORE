<%@ Page Language="C#" MasterPageFile="~/Report.Master" AutoEventWireup="true" CodeBehind="u_cri_coopid_recvperiod_rmembgroupcontrol.aspx.cs"
    Inherits="Saving.Criteria.u_cri_coopid_recvperiod_rmembgroupcontrol" Title="Report Criteria" %>
        ...
        <tr>
            <td align="center" style="width:500px">
                <dw:WebDataWindowControl ID="dw_criteria" runat="server" AutoRestoreContext="False"
                    ...
                    ClientScriptable="True" DataWindowObject="d_cri_coopid_recvperiod_rmembgroupcontrol"
