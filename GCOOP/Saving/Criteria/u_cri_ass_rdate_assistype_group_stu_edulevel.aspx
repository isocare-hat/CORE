<%@ Page Title="" Language="C#" MasterPageFile="~/Report.Master" AutoEventWireup="true" CodeBehind="u_cri_ass_rdate_assistype_group_stu_edulevel.aspx.cs" Inherits="Saving.Criteria.u_cri_ass_rdate_assistype_group_stu_edulevel" %>
        ...
        <tr>
            <td align="center" style="width:500px">
                <dw:WebDataWindowControl ID="dw_criteria" runat="server" AutoRestoreContext="False"
                    ...
                    ClientScriptable="True" DataWindowObject="d_cri_ass_rdate_asstype_group_edulevel"
