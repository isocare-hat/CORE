    ...
    <table style="width: 100%;">
        ...
        <tr>
            ...
            <td style="text-align:center">
                            <input id="ShifF11" type="button" value="ออกสมุดใหม่" onclick="DialBookNew()" style="height: 30px;
                    width: 100px; visibility:hidden;" />
            <input id="ShifF5" type="button" value="พิมพ์ปกสมุด" onclick="PrintNewBook()" style="height: 30px;
                    width: 100px;" />
                <input id="ShifF8" type="button" value="พิมพ์หัวสมุด" onclick="PrintBook_head()" style="height: 30px;
                    width: 100px;display:none;" />
                <input id="ShifF7" type="button" value="พิมพ์ BOOK" onclick="PrintBook()" style="height: 30px;
                    width: 100px;" />
        ...
        <tr>
             <td height="10">
                <dw:WebDataWindowControl ID="DwDetail" runat="server" AutoRestoreContext="False"
                    ...
                    LibraryList="~/DataWindow/ap_deposit/dp_conteck.pbl" ClientScriptable="True"  
