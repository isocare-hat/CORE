...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        //เรียกใบสำคัญจ่าย
            try {
                if (Gcoop.GetEl("HdIsPaymat").value == "true") {
                    Gcoop.GetEl("pring_paymat").src = "w_dlg_dp_printbook_int.aspx?dp_slip=" + Gcoop.GetEl("HdSlip").value;
                    $(function () {
                        $("#dialog_1").dialog(({
                            width: 550
                        }));
        ...
        function DialBookNew() {
            ...
            if (deptAccountNo != "") {
                ...
                var seqNo = 0;
                //Gcoop.OpenDlgIn(450, 180, "w_dlg_dp_booknew.aspx", "?deptAccountNo=" + deptAccountNo + "&deptPassBookNo=" + deptPassBookNo + "&deptTypeCode=" + deptTypeCode + "&seqNo=" + seqNo);
                //by_max 08/03/2017 แก้การเรียกหน้า พิมพ์สมุดใหม่
                Gcoop.GetEl("book_new").src = "w_dlg_dp_booknew.aspx?deptAccountNo=" + deptAccountNo + "&deptPassBookNo=" + deptPassBookNo + "&deptTypeCode=" + deptTypeCode + "&seqNo=" + seqNo;
                $(function () {
                    $("#dialog").dialog(({
                        width: 550
                    }));
...
<body>
    ...
    <div>
            ...
            <tr>
                <td align="center">
                 <dw:WebDataWindowControl ID="DwStm" runat="server" AutoRestoreContext="False"
                    ...
                    LibraryList="~/DataWindow/ap_deposit/dp_slip.pbl" RowsPerPage="15" ClientScriptable="True"
     ...
     <div id="dialog" title="ออกสมุดใหม่"  >
     <iframe id="book_new" src="about:blank" width="500" height="150" frameborder="0" scrolling="no"></iframe>
    </div>
     <div id="dialog_1" title="พิมพ์ใบสำคัญ"  >
     <iframe id="pring_paymat" src="about:blank" width="500" height="150" frameborder="0" scrolling="no"></iframe>
    </div>
        <asp:HiddenField ID="HdAccountNo" runat="server" />
        <asp:HiddenField ID="HdDpSlip" runat="server" Value="true" />
        <asp:HiddenField ID="HdChq" runat="server" Value="false" />
        ...
        <asp:HiddenField ID="HdIsPaymat" runat="server"  Value="false" />
        <asp:HiddenField ID="HdSlip" runat="server" />
    </div>
    </form>
</body>
</html>
