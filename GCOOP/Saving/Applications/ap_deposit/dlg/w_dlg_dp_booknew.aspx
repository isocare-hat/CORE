        ...
        <table>
            ...
            <tr>
                <td valign="top" align="center">
                    <input id="ok" class="buttonWidth" type="button" value="พิมพ์ปกสมุด" style="height: 40px;
                    width: 100px;" onclick="return ok_onclick()" />
                    &nbsp;&nbsp;
                    <input id="cancel" class="buttonWidth" type="button" value="ยกเลิก" style="height: 40px;
                    width: 100px;" onclick="return cancel_onclick()" />
                </td>
            </tr>
        </table>
        <br />
