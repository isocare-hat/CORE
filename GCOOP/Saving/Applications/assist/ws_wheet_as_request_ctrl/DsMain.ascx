    ...
    <EditItemTemplate>
        <table class="DataSourceFormView">            
            ...
            <tr>
                ...
                <td >
                    <asp:TextBox ID="membgroug" runat="server" ReadOnly="true" BackColor="#DDDDDD"  ></asp:TextBox>                   
                </td> 
                 <td  width="100px">
                    <div>
                ...
                <td colspan="3">
                    <asp:TextBox ID="membtype" runat="server" ReadOnly="true" BackColor="#DDDDDD" Style="text-align:center" ></asp:TextBox>                   
                </td> 
