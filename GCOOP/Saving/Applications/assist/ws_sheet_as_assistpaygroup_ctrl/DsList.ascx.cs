    ...
    public partial class DsList : DataSourceRepeater
    {
        ...
        public void RetrieveList(string sqlsearch)
        {
            String sql = @"select 
	                        ...
	                        (case when assreqmaster.moneytype_code = 'TRN' then assreqmaster.deptaccount_no else assreqmaster.expense_accid end) as expense_accid,
                        ...
                        where assreqmaster.req_status = 1  and trim(REF_SLIPNO) is null and
