...
{
    public partial class ws_sheet_as_cancel : PageWebSheet, WebSheet
    {
        [JsPostBack]
        ...
        public void WebSheetLoadBegin()
        {
            if (!IsPostBack)
            {
                ...
                dsMain.DATA[0].approve_start = state.SsWorkDate;
                dsMain.DATA[0].approve_end = state.SsWorkDate;
            }
        }
        ...
        public void CheckJsPostBack(string eventArg)
        {
            if (eventArg == PostSearch)
            {
                ...
                if ((dsMain.DATA[0].approve_start.ToString("dd/MM/yyyy") != "01/01/1500") && (dsMain.DATA[0].approve_end.ToString("dd/MM/yyyy") != "01/01/1500"))
                {
                    sqlwhere += " and assreqmaster.approve_date between to_date('" + dsMain.DATA[0].approve_start.ToString("dd/MM/yyyy") + "', 'dd/MM/yyyy') and to_date('" + dsMain.DATA[0].approve_end.ToString("dd/MM/yyyy") + "', 'dd/MM/yyyy')";
                }
                else { sqlwhere += ""; }
