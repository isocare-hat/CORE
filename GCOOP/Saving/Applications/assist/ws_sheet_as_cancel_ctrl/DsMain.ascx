<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DsMain.ascx.cs" Inherits="Saving.Applications.assist.ws_sheet_as_cancel_ctrl.DsMain" %>
    ...
    <table class="DataSourceFormView">
            <tr>
                 <td width="11%" valign="top">
                    <div>
                        <span>อนุมัติวันที่:</span>
                    </div>
                </td>
                <td width="26%" valign="top">
                    <asp:TextBox ID="approve_start" runat="server"></asp:TextBox> 
                </td>
                ...
                <td width="26%" valign="top">
                    <asp:TextBox ID="approve_end" runat="server"></asp:TextBox>
                </td>
                <td width="20%" valign="top">
