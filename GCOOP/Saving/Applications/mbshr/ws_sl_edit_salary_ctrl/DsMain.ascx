    ...
    <EditItemTemplate>
        <table class="DataSourceFormView">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="periodshare_value" runat="server" Style="text-align: right" BackColor="#DDDDDD" ToolTip="#,##0.00"></asp:TextBox>
                </td>
                <td>
                    <div>
                        <span>ค่าหุ้นต่อเดือน :</span></div>
                ...
                <td>
                    <asp:TextBox ID="new_periodshare_value" runat="server" Width="170px" Style="text-align: right" BackColor="#DDDDDD" ToolTip="#,##0.00"></asp:TextBox>
                </td>
            </tr>
        </table>
    </EditItemTemplate>
