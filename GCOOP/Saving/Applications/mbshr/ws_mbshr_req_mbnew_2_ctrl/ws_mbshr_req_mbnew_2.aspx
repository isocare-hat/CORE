<%@ Page Title="" Language="C#" MasterPageFile="~/Frame.Master" AutoEventWireup="true"
    CodeBehind="ws_mbshr_req_mbnew_2.aspx.cs" Inherits="Saving.Applications.mbshr.ws_mbshr_req_mbnew_2_ctrl.ws_mbshr_req_mbnew_2" %>
    ...
    <script type="text/javascript">
        ...
        function OnDsMainItemChanged(s, r, c, v) {
            if (c == "membdatefix_flag") {
                ...
                dsMain.SetItem(0, "membgroup_code", v);
            }
            ...
            else if (c == "tambol_code") {
                JsPostGetTambolPostcode();
            }
            else if (c == "currtambol_code") {
                JsPostGetCurrTambolPostcode();
            }
            else if (c == "bank_desc") {
        ...
        function GetMemGroupFromDlg(membgroup_code) {
            ...
            dsMain.SetItem(0, "membgroup", membgroup_code);
        }
