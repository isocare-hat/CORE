<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DsLoan.ascx.cs" Inherits="Saving.Applications.divavg.ws_divsrv_detail_ctrl.DsLoan" %>
...
<asp:Panel ID="Panel2" runat="server" ScrollBars="Auto" HorizontalAlign="Center">
    <table class="DataSourceRepeater" align="center">
        ...
        <tr>
            ...
            รวมดอกเบี้ยสะสมทั้งหมด
            </td>
            <td width="20%">
                <asp:TextBox ID="cpinterest_accum" runat="server" Style="text-align: right;" ToolTip="#,##0.00"
                    ReadOnly="true"></asp:TextBox>
            </td>
        </tr>
    </table>
