...
//                and ( yrcfrateln.calavg_flag = 1 )
//	            and ( yrbglonmaster.coop_id = {0} )
//	            and ( yrbglonmaster.member_no = {1} )
//	            and ( trim(yrbglonmaster.div_year) = {2} )";
            ...
            string sql = @"select yrbglonmaster.coop_id,   
                        ...
                        from yrbglonmaster,yrcfrate
                        where trim(yrbglonmaster.div_year) = trim(yrcfrate.div_year)
                            and ( yrbglonmaster.coop_id = {0} )
            	            and ( yrbglonmaster.member_no = {1} )
            	            and ( trim(yrbglonmaster.div_year) = {2} )";
        ...
        {
            get { return this.cpinterest_accum; }
        }
    }
}