...
<asp:FormView ID="FormView1" runat="server" DefaultMode="Edit" Width="480px">
    <EditItemTemplate>
        <table class="DataSourceFormView" width="500px">
            <tr>
                <td width="15%"> <div> <span> ตั้งแต่วันที่ :</span> </div> </td>
                <td width="30%"> <asp:TextBox ID="cont_sdate" runat="server" Style="text-align:center;"></asp:TextBox></td>
                <td width="15%"> <div> <span> ถึงวันที่ :</span> </div> </td>
                <td width="30%"><asp:TextBox ID="cont_edate" runat="server" Style="text-align:center;"></asp:TextBox></td>
            </tr>
            <tr>
